...
import com.linghushaoxia.http.parse.TestLoaderNG.Header;
import com.linghushaoxia.http.parse.TestLoaderNG.LastHeader;
import com.linghushaoxia.http.parse.impl.HTTPMethod;
import com.linghushaoxia.http.parse.impl.HTTPParserUrl;
...
public class Message {
  ...
  IHTTPDataCallback getCB (final String value, final String mes, final TestSettings settings) {
    return new IHTTPDataCallback() {
  ...
  TestSettings settings() {
    ...
    s.on_message_begin = new IHTTPCallback() {
      public int cb (HTTPParser p) {
        message_begin_called = true;
        return -1;
      }
    };
    s.on_header_field = new IHTTPDataCallback() {
      public int cb (HTTPParser p, ByteBuffer b, int pos, int len){
    ...
    s.on_header_value = new IHTTPDataCallback() {
      public int cb (HTTPParser p, ByteBuffer b, int pos, int len){
        if (null == currHField) {
    ...
    s.on_headers_complete = new IHTTPCallback() {
      public int cb (HTTPParser p) {
    ...
    s.on_body = new IHTTPDataCallback() {
      public int cb (HTTPParser p, ByteBuffer b, int pos, int len){
    ...
    s.on_message_complete = new IHTTPCallback() {
      public int cb(HTTPParser p) {
